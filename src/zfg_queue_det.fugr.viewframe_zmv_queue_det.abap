*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_QUEUE_DET
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_QUEUE_DET       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_QUEUE_DET'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_QUEUE_DET_EXTRACT
TOTAL = ZMV_QUEUE_DET_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_QUEUE_DET'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_QUEUE_DET-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_QUEUE_DET_EXTRACT
TOTAL = ZMV_QUEUE_DET_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_QUEUE_DET-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_QUEUE_DET'
...
TOTAL = ZMV_QUEUE_DET_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_QUEUE_DET-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_QUEUE_DET-UPD_FLAG NE SPACE.
