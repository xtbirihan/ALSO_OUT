*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_WOCR_PCKIN
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_WOCR_PCKIN      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_WOCR_PCKIN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_WOCR_PCKIN_EXTRACT
TOTAL = ZMV_WOCR_PCKIN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_WOCR_PCKIN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_WOCR_PCKIN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WOCR_PCKIN_EXTRACT
TOTAL = ZMV_WOCR_PCKIN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_WOCR_PCKIN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_WOCR_PCKIN'
...
TOTAL = ZMV_WOCR_PCKIN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_WOCR_PCKIN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_WOCR_PCKIN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_WOCR_PCKIN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_WOCR_PCKIN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WOCR_PCKIN_EXTRACT
TOTAL = ZMV_WOCR_PCKIN_TOTAL
