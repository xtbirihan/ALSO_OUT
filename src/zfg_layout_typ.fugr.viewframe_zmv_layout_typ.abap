*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_LAYOUT_TYP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_LAYOUT_TYP      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_LAYOUT_TYP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_LAYOUT_TYP_EXTRACT
TOTAL = ZMV_LAYOUT_TYP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_LAYOUT_TYP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_LAYOUT_TYP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_LAYOUT_TYP_EXTRACT
TOTAL = ZMV_LAYOUT_TYP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_LAYOUT_TYP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_LAYOUT_TYP'
...
TOTAL = ZMV_LAYOUT_TYP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_LAYOUT_TYP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_LAYOUT_TYP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_LAYOUT_TYP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_LAYOUT_TYP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_LAYOUT_TYP_EXTRACT
TOTAL = ZMV_LAYOUT_TYP_TOTAL
