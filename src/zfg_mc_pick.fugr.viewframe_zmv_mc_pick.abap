*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_MC_PICK
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_MC_PICK         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_MC_PICK'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_MC_PICK_EXTRACT
TOTAL = ZMV_MC_PICK_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_MC_PICK'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_MC_PICK-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_MC_PICK_EXTRACT
TOTAL = ZMV_MC_PICK_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_MC_PICK-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_MC_PICK'
...
TOTAL = ZMV_MC_PICK_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_MC_PICK-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_MC_PICK-UPD_FLAG NE SPACE.
