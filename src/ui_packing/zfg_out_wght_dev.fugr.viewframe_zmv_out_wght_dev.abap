*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_OUT_WGHT_DEV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_OUT_WGHT_DEV    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_OUT_WGHT_DEV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_OUT_WGHT_DEV_EXTRACT
TOTAL = ZMV_OUT_WGHT_DEV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_OUT_WGHT_DEV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_OUT_WGHT_DEV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_OUT_WGHT_DEV_EXTRACT
TOTAL = ZMV_OUT_WGHT_DEV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_OUT_WGHT_DEV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_OUT_WGHT_DEV'
...
TOTAL = ZMV_OUT_WGHT_DEV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_OUT_WGHT_DEV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_OUT_WGHT_DEV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_OUT_WGHT_DEV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_OUT_WGHT_DEV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_OUT_WGHT_DEV_EXTRACT
TOTAL = ZMV_OUT_WGHT_DEV_TOTAL
