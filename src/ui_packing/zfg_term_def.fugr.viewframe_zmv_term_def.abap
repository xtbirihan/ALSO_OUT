*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_TERM_DEF
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_TERM_DEF        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_TERM_DEF'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_TERM_DEF_EXTRACT
TOTAL = ZMV_TERM_DEF_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_TERM_DEF'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_TERM_DEF-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_TERM_DEF_EXTRACT
TOTAL = ZMV_TERM_DEF_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_TERM_DEF-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_TERM_DEF'
...
TOTAL = ZMV_TERM_DEF_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_TERM_DEF-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_TERM_DEF-UPD_FLAG NE SPACE.
