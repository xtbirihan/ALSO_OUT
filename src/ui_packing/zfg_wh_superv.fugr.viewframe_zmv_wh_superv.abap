*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_WH_SUPERV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_WH_SUPERV       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_WH_SUPERV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_WH_SUPERV_EXTRACT
TOTAL = ZMV_WH_SUPERV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_WH_SUPERV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_WH_SUPERV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WH_SUPERV_EXTRACT
TOTAL = ZMV_WH_SUPERV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_WH_SUPERV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_WH_SUPERV'
...
TOTAL = ZMV_WH_SUPERV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_WH_SUPERV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_WH_SUPERV-UPD_FLAG NE SPACE.
