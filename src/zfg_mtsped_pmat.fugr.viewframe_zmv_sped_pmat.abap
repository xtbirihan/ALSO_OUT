*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_SPED_PMAT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_SPED_PMAT       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_SPED_PMAT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_SPED_PMAT_EXTRACT
TOTAL = ZMV_SPED_PMAT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_SPED_PMAT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_SPED_PMAT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_SPED_PMAT_EXTRACT
TOTAL = ZMV_SPED_PMAT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_SPED_PMAT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_SPED_PMAT'
...
TOTAL = ZMV_SPED_PMAT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_SPED_PMAT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_SPED_PMAT-UPD_FLAG NE SPACE.
