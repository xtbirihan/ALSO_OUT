*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_WHOPACKLIM
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_WHOPACKLIM      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_WHOPACKLIM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_WHOPACKLIM_EXTRACT
TOTAL = ZMV_WHOPACKLIM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_WHOPACKLIM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_WHOPACKLIM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WHOPACKLIM_EXTRACT
TOTAL = ZMV_WHOPACKLIM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_WHOPACKLIM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_WHOPACKLIM'
...
TOTAL = ZMV_WHOPACKLIM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_WHOPACKLIM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_WHOPACKLIM-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_WHOPACKLIM'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_WHOPACKLIM-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WHOPACKLIM_EXTRACT
TOTAL = ZMV_WHOPACKLIM_TOTAL
