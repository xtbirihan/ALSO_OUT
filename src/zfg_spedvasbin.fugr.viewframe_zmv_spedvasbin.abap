*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_SPEDVASBIN
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_SPEDVASBIN      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_SPEDVASBIN'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_SPEDVASBIN_EXTRACT
TOTAL = ZMV_SPEDVASBIN_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_SPEDVASBIN'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_SPEDVASBIN-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_SPEDVASBIN_EXTRACT
TOTAL = ZMV_SPEDVASBIN_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_SPEDVASBIN-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_SPEDVASBIN'
...
TOTAL = ZMV_SPEDVASBIN_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_SPEDVASBIN-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_SPEDVASBIN-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_SPEDVASBIN'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_SPEDVASBIN-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_SPEDVASBIN_EXTRACT
TOTAL = ZMV_SPEDVASBIN_TOTAL
