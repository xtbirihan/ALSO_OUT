*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_POSC_CMAP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_POSC_CMAP       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_POSC_CMAP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_POSC_CMAP_EXTRACT
TOTAL = ZMV_POSC_CMAP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_POSC_CMAP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_POSC_CMAP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_POSC_CMAP_EXTRACT
TOTAL = ZMV_POSC_CMAP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_POSC_CMAP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_POSC_CMAP'
...
TOTAL = ZMV_POSC_CMAP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_POSC_CMAP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_POSC_CMAP-UPD_FLAG NE SPACE.
