*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_SVKWC_STAG
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_SVKWC_STAG      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_SVKWC_STAG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_SVKWC_STAG_EXTRACT
TOTAL = ZMV_SVKWC_STAG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_SVKWC_STAG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_SVKWC_STAG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_SVKWC_STAG_EXTRACT
TOTAL = ZMV_SVKWC_STAG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_SVKWC_STAG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_SVKWC_STAG'
...
TOTAL = ZMV_SVKWC_STAG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_SVKWC_STAG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_SVKWC_STAG-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_SVKWC_STAG'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_SVKWC_STAG-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_SVKWC_STAG_EXTRACT
TOTAL = ZMV_SVKWC_STAG_TOTAL
