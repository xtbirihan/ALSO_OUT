*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_QUE_LY_MAP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_QUE_LY_MAP      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_QUE_LY_MAP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_QUE_LY_MAP_EXTRACT
TOTAL = ZMV_QUE_LY_MAP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_QUE_LY_MAP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_QUE_LY_MAP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_QUE_LY_MAP_EXTRACT
TOTAL = ZMV_QUE_LY_MAP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_QUE_LY_MAP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_QUE_LY_MAP'
...
TOTAL = ZMV_QUE_LY_MAP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_QUE_LY_MAP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_QUE_LY_MAP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_QUE_LY_MAP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_QUE_LY_MAP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_QUE_LY_MAP_EXTRACT
TOTAL = ZMV_QUE_LY_MAP_TOTAL
