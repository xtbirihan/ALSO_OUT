*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_WHOWCRFLTR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_WHOWCRFLTR      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_WHOWCRFLTR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_WHOWCRFLTR_EXTRACT
TOTAL = ZMV_WHOWCRFLTR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_WHOWCRFLTR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_WHOWCRFLTR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WHOWCRFLTR_EXTRACT
TOTAL = ZMV_WHOWCRFLTR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_WHOWCRFLTR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_WHOWCRFLTR'
...
TOTAL = ZMV_WHOWCRFLTR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_WHOWCRFLTR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_WHOWCRFLTR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_WHOWCRFLTR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_WHOWCRFLTR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WHOWCRFLTR_EXTRACT
TOTAL = ZMV_WHOWCRFLTR_TOTAL
