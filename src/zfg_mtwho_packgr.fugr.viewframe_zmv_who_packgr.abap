*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_WHO_PACKGR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_WHO_PACKGR      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_WHO_PACKGR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_WHO_PACKGR_EXTRACT
TOTAL = ZMV_WHO_PACKGR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_WHO_PACKGR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_WHO_PACKGR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WHO_PACKGR_EXTRACT
TOTAL = ZMV_WHO_PACKGR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_WHO_PACKGR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_WHO_PACKGR'
...
TOTAL = ZMV_WHO_PACKGR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_WHO_PACKGR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_WHO_PACKGR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_WHO_PACKGR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_WHO_PACKGR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_WHO_PACKGR_EXTRACT
TOTAL = ZMV_WHO_PACKGR_TOTAL
